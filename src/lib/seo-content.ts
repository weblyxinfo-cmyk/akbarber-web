...
export const seoLocationPages: Record<string, SeoLocationContent> = {
  ...
  "barber-cerny-most": {
    ...
    faq: [
      ...
      { question: "Máte i další pobočky v Praze?", answer: "Ano, v Praze máme pobočky Praha 1 Máj (Národní 63/26, centrum), Praha 3 Žižkov (Husitská 55), Praha 5 Smíchov (Toyen 3410/7, u metra Anděl) a Praha 6 Břevnov (Radimova 2522/4, dříve Bělohorská). Všechny pracují pod jednotnými standardy AK BARBERS." },
    ],
    internalLinks: [
  ...
  "barber-praha-3": {
    ...
    slug: "barber-praha-3",
    locationId: "praha-3",
    title: "Barber Praha 3 – Žižkov | Největší barber shop v ČR s kavárnou | AK BARBERS",
    description:
      "Největší barber shop v České republice na Žižkově, Husitská 55, Praha 3 – propojený s kavárnou NOA Matcha Café. Walk-in i online rezervace. Pánské stříhání od 499 Kč, skin fade, úprava vousů. Pár minut od Florence a centra Prahy.",
    keywords: [
      "barber praha 3",
      "barber žižkov",
      "barbershop žižkov",
    ...
    localityDescription: [
      ...
      "Fungujeme jako walk-in i na rezervaci — přijďte kdykoliv bez objednání, nebo si pohodlně zarezervujte termín online přes Booqme. Užijte si profesionální střih od barberů vyškolených v AK BARBERS Academy. Otevřeno máme Po–Pá 10:00–19:00 a v sobotu 10:00–14:00. Na Žižkově navazujeme na osvědčenou kvalitu z poboček Praha 1 Máj, Praha 5 Smíchov, Praha 6 Břevnov a Praha 9 Černý Most.",
    ],
    services: [
      { name: "Klasické pánské stříhání", price: "499 Kč" },
      { name: "Skin Fade / dlouhé vlasy", price: "499 Kč" },
    ...
    aboutText:
      "V AK BARBERS pracujeme podle přísných standardů kvality. Každý nový barber prochází profesionálním zaškolením v naší AK BARBERS Academy a teprve poté nastupuje do provozu. Preciznost, čistota a důraz na detail jsou základem naší práce. Díky tomu držíme špičkovou úroveň služeb na každé pobočce — a naši zákazníci se k nám rádi vrací.",
    faq: [
      { question: "Kde přesně se nachází AK BARBERS Praha 3?", answer: "Na adrese Husitská 55, 130 00 Praha 3 – Žižkov, pod vrchem Vítkov. Jsme pár minut od metra a autobusového nádraží Florenc (linky B a C) a od tramvajové zastávky Lipanská (linky 5, 9, 15, 26)." },
      ...
      { question: "Jaká je otevírací doba na Žižkově?", answer: "Po–Pá 10:00–19:00 a v sobotu 10:00–14:00. V neděli máme zavřeno." },
      ...
      { question: "Kde můžu zaparkovat?", answer: "V modrých a fialových parkovacích zónách Prahy 3 přímo v okolí Husitské (cca 20 Kč/hod)." },
      { question: "Je Žižkov opravdu největší barber shop v Česku?", answer: "Ano. Naše pobočka na Husitské je největší barber shop v České republice – se 14 barberskými křesly nabízí prémiovou péči a krátké čekání i ve špičce." },
      { question: "Máte na Žižkově i kavárnu?", answer: "Ano, naše pobočka na Žižkově je propojená s moderní kavárnou NOA Matcha Café. Zatímco si užíváte střih, můžete si přímo v křesle vychutnat výběrovou kávu nebo matchu." },
    ...
    internalLinks: [
      { label: "Pánské stříhání Praha 3 – Žižkov", href: "/pansky-strih-praha-3" },
      { label: "Skin Fade Praha 3 – Žižkov", href: "/skin-fade-praha-3" },
      { label: "AK BARBERS – Praha Máj (Praha 1)", href: "/barber-praha-1" },
      { label: "AK BARBERS Praha 5 – Smíchov", href: "/barber-smichov" },
      { label: "AK BARBERS Praha 9 – Černý Most", href: "/barber-cerny-most" },
      { label: "NOA Matcha Café – kavárna na pobočce", href: "https://www.noamatcha.cz", external: true },
      academyLink,
      careerLink,
    ],
    breadcrumbs: [
...
export const seoServicePages: Record<string, SeoServiceContent> = {
  ...
  "pansky-strih-praha-3": {
    ...
    description:
      "Profesionální pánské stříhání na Žižkově, Husitská 55, Praha 3. Klasický střih od 499 Kč, konzultace a styling v ceně. Walk-in i online rezervace. AK BARBERS.",
    keywords: [
      "pánské stříhání praha 3",
      "pánský střih žižkov",
      "kadeřnictví muži praha 3",
  ...
  "skin-fade-praha-3": {
    ...
    description:
      "Precizní skin fade na Žižkově, Husitská 55, Praha 3. Low, mid i high fade od 499 Kč, přechody od 0 mm. Walk-in i online rezervace. AK BARBERS.",
    keywords: [
      "skin fade praha 3",
      "skin fade žižkov",
      "fade střih praha 3",
