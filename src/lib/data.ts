...
export const locations: Location[] = [
  ...
  },
  {
    ...
    city: "Praha",
    address: "Radimova 2522/4, 169 00 Praha 6 – Břevnov",
    phone: "+420 775 502 831",
    openingHours: [
      { days: "Po – Pá", hours: "10:00 – 19:00" },
      { days: "So", hours: "10:00 – 14:00" },
    ...
    currency: "CZK",
    googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=AK+Barbers+Radimova+2522%2F4+Praha+6+Br%C5%99evnov",
    reviewRating: 4.8,
    reviewCount: "250+",
    rankText: "Top #1 Barbershop na Praze 6 podle Googlu",
    mapQuery: "AK+Barbers,+Radimova+2522/4,+Praha+6+Břevnov",
    geo: { lat: 50.0843, lng: 14.3835 },
    transport: {
      publicTransport: [
        "Tramvaj Marjánka – linky 22, 25 (2 min chůze)",
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Detský strih (1–15 rokov)", price: "14,50 € / 17,50 €", description: "Strihanie mladých mužov vo veku od 1 do 15 rokov. Klasický strih, fúkaná, styling. Vždy radi poradíme. Skin Fade / Low Fade / Crop Fade / Buzz Cut + 3 €." },
      { name: "Úprava brady", price: "16,50 €", description: "Úprava fúzov britvou, ošetrenie pleti." },
    ],
