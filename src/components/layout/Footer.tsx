      ...
      <div className="container">
        <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
          <a href="/" className="flex items-center gap-3">
            <Image src="/images/logo.svg" alt="AK Barbers" width={48} height={48} className="h-12 w-auto" />
            <span className="text-lg font-bold tracking-wide text-white">AK BARBERS</span>
          </a>
        ...
        <div className="mt-10 flex flex-col items-start gap-4 border-t border-border pt-6 sm:flex-row sm:items-center sm:justify-between">
          <span className="text-xs text-gray">&copy; {new Date().getFullYear()} AK.BARBERS</span>
