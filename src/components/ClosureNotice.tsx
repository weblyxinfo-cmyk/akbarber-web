...
// Po znovuotevření pobočky Praha 6 zobrazujeme zelené oznámení.
// Automaticky zmizí po tomto datu (cca 14 dní od otevření).
const STORAGE_KEY = "ak-reopen-praha6-dismissed";
const HIDE_AFTER = new Date("2026-06-17T23:59:59");
  ...
  return (
    ...
    >
      ...
      <p className="mb-3 text-[12px] leading-[1.5] text-gray">
        Naše břevnovská pobočka je opět otevřena – nově na adrese{" "}
        <span className="font-semibold text-white">Radimova 2522/4, Praha 6 – Břevnov</span>. Stejný tým, bez objednání i na rezervaci. Stavte se za námi!
      </p>
      <Link
